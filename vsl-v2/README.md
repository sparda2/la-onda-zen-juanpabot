# VSL Versión 2 - La Onda Zen

Esta es la versión 2 de la página de presentación (VSL) de "La Onda Zen", optimizada para ser insertada en constructores como WordPress y GoHighLevel.
